...
<p align="left">Я начинающий Backend разработчик. Мой путь в it начался с идеи создать читалку для манг😝. Попробовав себя в Python и C#, я остановился на выборе Python. С июня 2024 года по июль включительно 2024 я изучал Frontend разработку на курсах от Александра Ламкова, параллельно проходил курс от Sololearn по HTML, CSS, JS, а также изучал "Современный учебник по JS". В настоящий момент мое обучение на курсе по HTML и CSS от Александра Ламкова завершено, я получил сертификат о прохождении курсов основ HTML, CSS, JS, Python от Sololearn, и в данный момент активно изучаю Python, практикуюсь с задачками, а также пишу совместный проект: Телеграмм бот с парсером. Ну и конечно же изучаю работу с Git и Github^^</p>
